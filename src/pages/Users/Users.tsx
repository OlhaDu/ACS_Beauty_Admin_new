    ...
    <AdminLayout>
      <main className={s.main}>
        <section className={s.main__section}>
            ...
            <div className={s.features}>
              ...
              <div className={s.tools}>
                <section className={s.options__container}>
                  <Select options={filteringOptions} icon={<FilterIcon />} toolName={'Фільтрувати'} />
                  <Select options={actionOptions} icon={<ActionsIcon />} toolName={'Дії'} />
                  <Select options={exportOptions} icon={<ExportFileIcon />} toolName={'Експортувати'} />
                </section>
                <Select
          ...
          <FullFeaturedCrudGrid columns={customColumns} rows={users} onExternalDataUpdate={handleExternalDataUpdate} />
        </section>
      </main>
    </AdminLayout>
  )
