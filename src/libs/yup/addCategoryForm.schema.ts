...
export const addCategoryFormSchema = Yup.object({
  name: Yup.string()
    ...
    .matches(
      /^[АаБбВвГгҐґДдЕеЄєЖжЗзИиІіЇїЙйКкЛлМмНнОоПпРрСсТтУуФфХхЦцЧчШшЩщьЮюЯяABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz,.:;'"{}*%()\s\d]+$/g,
  ...
  description: Yup.string()
    ...
    .matches(
      /^[АаБбВвГгҐґДдЕеЄєЖжЗзИиІіЇїЙйКкЛлМмНнОоПпРрСсТтУуФфХхЦцЧчШшЩщьЮюЯяABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz,.:;'"{}*%()\d\s]+$/g,
      "Можна використовувати лише українські та латинські літери, знаки пунктуації, цифри та пробіли"
    ),
  image: Yup.mixed()
    .required("Обов`язковий")
