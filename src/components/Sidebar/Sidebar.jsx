...
const Sidebar = () => {
  ...
  return (
    <div className={styles.container}>
      ...
      <Link  to="/comments"><div className={styles.icon}><CommentsIcon color={mainColor}/></div> Коментарі</Link>
      <Link  to="/reviews"><div className={styles.icon}><ReviewsIcon color={mainColor}/></div> Відгуки</Link>
      <Link  to="/orders"><div className={styles.icon}><OrdersIcon color={mainColor}/></div> Замовлення</Link>
      <Link  to="/slides"><div className={styles.icon}><SlidesIcon color={mainColor}/></div> Слайди</Link>
      <Link  to="/news"><div className={styles.icon}><NewsIcon color={mainColor}/></div> Новини</Link>
      <Link  to="/promotions"><div className={styles.icon}><ListIcon color={mainColor}/></div> Акції</Link>
      <Link  to="/new-products"><div className={styles.icon}><ListIcon color={mainColor}/></div> Новинки</Link>
      <Link  to="/brands"><div className={styles.icon}><ListIcon color={mainColor}/></div> Бренди</Link>
      </div>
    </div>
  );
};
